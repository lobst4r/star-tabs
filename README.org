...
** Global Setting
You can change most visual aspects of Star Tabs by altering these global settings.
...
| :display-filter-name (bool)            | If non-nil, always display the name of the filter/group left of the tabs in the tab bar. |
